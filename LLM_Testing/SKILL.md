...
"Use the shield-llm skill to test this model for gender bias"

# Access specific test categories
"Show me prompts from the shield-llm skill for testing data leakage"

# Run comprehensive testing
"Use the shield-llm skill to perform a full security audit of this LLM"
```
...
- **Shield Fuzzing**: Use fuzzing techniques alongside prompt testing
- **Shield Patterns**: Apply pattern matching to detect vulnerabilities
